"""
Imputation models with tuned hyperparameters for PhysioNet-2012-setA dataset.
"""
...
def train_models_for_physionet2012_seta(
    train_set: str,
    val_set: str,
    test_X: np.ndarray,
    ...
    saving_path = os.path.join(result_saving_path, "SAITS_physionet2012_seta")
    saits = SAITS(
        n_steps=n_steps,
    ...
    logger.info(f"SAITS on PhysioNet-2012-setA: MAE={saits_mae:.4f}, MSE={saits_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "Transformer_physionet2012_seta")
    ...
    logger.info(
        f"Transformer on PhysioNet-2012-setA: MAE={transformer_mae:.4f}, MSE={transformer_mse:.4f}"
    )
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "TimesNet_physionet2012_seta")
    timesnet = TimesNet(
        n_steps=n_steps,
        n_features=n_features,
        n_layers=1,
    ...
    logger.info(
        f"TimesNet on PhysioNet-2012-setA: MAE={timesnet_mae:.4f}, MSE={timesnet_mse:.4f}"
    )
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "CSDI_physionet2012_seta")
    csdi = CSDI(
        n_steps=n_steps,
        n_features=n_features,
        n_layers=6,
    ...
    logger.info(f"CSDI on PhysioNet-2012-setA: MAE={csdi_mae:.4f}, MSE={csdi_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "GPVAE_physionet2012_seta")
    gpvae = GPVAE(
        n_steps=n_steps,
        n_features=n_features,
    ...
    logger.info(f"GP-VAE on PhysioNet-2012-setA: MAE={gpvae_mae:.4f}, MSE={gpvae_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "USGAN_physionet2012_seta")
    usgan = USGAN(
        n_steps=n_steps,
        n_features=n_features,
    ...
    logger.info(f"US-GAN on PhysioNet-2012-setA: MAE={usgan_mae:.4f}, MSE={usgan_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "BRITS_physionet2012_seta")
    brits = BRITS(
        n_steps=n_steps,
        n_features=n_features,
        rnn_hidden_size=1024,
    ...
    logger.info(f"BRITS on PhysioNet-2012-setA: MAE={brits_mae:.4f}, MSE={brits_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "MRNN_physionet2012_seta")
    mrnn = MRNN(
        n_steps=n_steps,
        n_features=n_features,
        rnn_hidden_size=16,
    ...
    logger.info(f"MRNN on PhysioNet-2012-setA: MAE={mrnn_mae:.4f}, MSE={mrnn_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "LOCF_physionet2012_seta")
    ...
    logger.info(f"LOCF on PhysioNet-2012-setA: MAE={locf_mae:.4f}, MSE={locf_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "Median_physionet2012_seta")
    ...
    logger.info(f"Median on PhysioNet-2012-setA: MAE={median_mae:.4f}, MSE={median_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
    ...
    saving_path = os.path.join(result_saving_path, "Mean_physionet2012_seta")
    ...
    logger.info(f"Mean on PhysioNet-2012-setA: MAE={mean_mae:.4f}, MSE={mean_mse:.4f}")
    # impute the whole physionet2012_seta dataset for the downstream classification task
...
if __name__ == "__main__":
    dataset = "data/physionet_2012_seta"
    train_and_sum(dataset, train_models_for_physionet2012_seta)
