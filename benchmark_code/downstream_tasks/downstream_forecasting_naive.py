...
if __name__ == "__main__":
    ...
    logger.info(f"Start running downstream regression task on {args.dataset_fold_path}")
    ...
    for naive_method in ["mean", "median", "locf", "linear_interpolation"]:
        ...
        logger.info(
            "\n"
            f"XGB (with {naive_method} imputation) forecasting "
            ...
            f"RNN (with {naive_method} imputation) forecasting "
            ...
            f"Transformer (with {naive_method} imputation) forecasting "
