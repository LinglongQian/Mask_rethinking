...
if __name__ == "__main__":
    ...
    logger.info(
        "\n"
        f"XGB (without imputation) forecasting "
        ...
        f"XGB (with {args.model} imputation) forecasting "
        ...
        f"RNN (with {args.model} imputation) forecasting "
        ...
        f"Transformer (with {args.model} imputation) forecasting "
