...
if __name__ == "__main__":
    ...
    train_X_ori = train_set_X
    train_X = mcar_augmentation(train_set_X, ARTIFICIALLY_MISSING_RATE)
    train_set_dict = {
        "X": train_X,
        "X_ori": train_X_ori,
    }
    ...
    val_X = mcar_augmentation(val_set_X, ARTIFICIALLY_MISSING_RATE)
    val_set_dict = {
        "X": val_X,
        "X_ori": val_X_ori,
    }
    ...
    test_X = mcar_augmentation(test_set_X, ARTIFICIALLY_MISSING_RATE)
    test_set_dict = {
        "X": test_X,
        "X_ori": test_X_ori,
    }
