...
def train_models_for_physionet_2012_seta(
    train_set: str,
    val_set: str,
    test_X: np.ndarray,
    ...
    saving_path = os.path.join(result_saving_path, "SAITS_physionet_2012_seta")
    saits = SAITS(
        n_steps=n_steps,
    ...
    saving_path = os.path.join(result_saving_path, "Transformer_physionet_2012_seta")
    ...
    saving_path = os.path.join(result_saving_path, "TimesNet_physionet_2012_seta")
    timesnet = TimesNet(
        n_steps=n_steps,
        n_features=n_features,
        n_layers=1,
    ...
    saving_path = os.path.join(result_saving_path, "CSDI_physionet_2012_seta")
    csdi = CSDI(
        n_steps=n_steps,
        n_features=n_features,
        n_layers=6,
    ...
    saving_path = os.path.join(result_saving_path, "GPVAE_physionet_2012_seta")
    gpvae = GPVAE(
        n_steps=n_steps,
        n_features=n_features,
    ...
    saving_path = os.path.join(result_saving_path, "USGAN_physionet_2012_seta")
    usgan = USGAN(
        n_steps=n_steps,
        n_features=n_features,
    ...
    saving_path = os.path.join(result_saving_path, "BRITS_physionet_2012_seta")
    brits = BRITS(
        n_steps=n_steps,
        n_features=n_features,
        rnn_hidden_size=1024,
    ...
    saving_path = os.path.join(result_saving_path, "MRNN_physionet_2012_seta")
    mrnn = MRNN(
        n_steps=n_steps,
        n_features=n_features,
        rnn_hidden_size=16,
    ...
    saving_path = os.path.join(result_saving_path, "LOCF_physionet_2012_seta")
    ...
    saving_path = os.path.join(result_saving_path, "Median_physionet_2012_seta")
    ...
    saving_path = os.path.join(result_saving_path, "Mean_physionet_2012_seta")
...
if __name__ == "__main__":
    ...
    train_and_sum(dataset, train_models_for_physionet_2012_seta)
