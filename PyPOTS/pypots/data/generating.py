...
def gene_physionet2019(artificially_missing_rate: float = 0.1):
    """Generate a fully-prepared PhysioNet-2019 dataset for model testing.
    ...
    # generate samples
    dataset = load_specific_dataset("physionet_2019")
    X = dataset["X"]
    y = dataset["y"]
    ICUType = dataset["ICUType"]
